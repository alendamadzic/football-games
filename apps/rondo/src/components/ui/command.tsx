...
function CommandInput({
  ...
  return (
    <div data-slot="command-input-wrapper" className="p-1">
      <InputGroup className="border-transparent bg-transparent px-3">
        <CommandPrimitive.Input
          data-slot="command-input"
          className={cn(
            "w-full px-2 text-base sm:text-sm outline-hidden disabled:cursor-not-allowed disabled:opacity-50",
            className,
          )}
          {...props}
        />
